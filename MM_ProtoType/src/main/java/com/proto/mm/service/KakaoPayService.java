...
public class KakaoPayService {
    ...
    public String kakaoPayReady(Model model, HttpServletRequest request, HttpServletResponse response) {
        ...
        params.add("approval_url", "52.200.16.8:8090/kakaoPaySuccess");
        params.add("cancel_url", "52.200.16.8:8090/kakaoPayCancel");
        params.add("fail_url", "52.200.16.8:8090/kakaoPaySuccessFail");
